...
def synthesizer():
    ...
    parser.add_argument('--mdot', action='store', type=float, default=None,
                        help='Mass accretion rate in Msun/yr (if model is ppdisk)')
    ...
    parser.add_argument('--show-mc', action='store_true', default=False,
                        help='Plot the Monte-Carlo temperature in 2D.')

    parser.add_argument('--show-mc-3d', action='store_true', default=False,
                        help='Render the Monte-Carlo temperature in 3D.')
    ...
    pipeline = Pipeline(
        ...
        amax=cli.amax,
        na=cli.na,
        csubl=cli.sublimation,
        sootline=cli.sootline,
    ...
    if cli.grid:
        pipeline.create_grid(
            ...
            render=cli.render,
            vtk=cli.vtk,
            show_2d=cli.show_grid_2d,
            show_3d=cli.show_grid_3d,
            vector_field=cli.vector_field,
            tau=cli.tau,
            show_particles=cli.show_particles,
            alignment=cli.alignment,
            cmap=cli.cmap,
            rin=cli.rin,
            rout=cli.rout,
            ...
            dr_gap=cli.dr_gap,
            rho0=cli.rho0,
            save_grid_2d=cli.save_grid_2d,
            save_grid_3d=cli.save_grid_3d,
        )
    ...
    if cli.raytrace:
        pipeline.raytrace(
            ...
            noscat=cli.noscat,
            tau=cli.tau,
            tau_surf=cli.tau_surf,
            show_tau_surf=cli.show_tau_surf,
            radmc3d_cmds=cli.radmc3d,
            cmap=cli.cmap,
            stretch=cli.stretch,
        )
    ...
    if cli.synobs:
        pipeline.synthetic_observation(
            show=cli.show_synobs,
            script=cli.script,
            simobserve=not cli.dont_observe,
            clean=not cli.dont_clean,
            exportfits=not cli.dont_export,
            obstime=cli.obstime,
            resolution=cli.resolution,
            obsmode=cli.obsmode,
            use_template=cli.use_template,
            no_noise=cli.no_noise,
            telescope=cli.telescope,
            verbose=not cli.quiet,
            cmap=cli.cmap,
            stretch=cli.stretch,
        )
